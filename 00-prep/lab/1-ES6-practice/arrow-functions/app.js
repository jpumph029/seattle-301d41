...
//  this is different when used in an arrow function beacause arrow functions 'bubble' up to the next nearest scope. Since we used arrow functions in the file exclusivly its going to attach itself to global window object.
